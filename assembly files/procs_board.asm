...
.data
key_array:	.word	0x16, 0x1E, 0x26, 0x25, 0x2E, 0x36, 0x3D, 0x3E, 0xF016, 0xF01E, 0xF026, 0xF025, 0xF02E, 0xF036, 0xF03D, 0xF03E   	# keys 1 thru 8

num_keys:	.word	16				# put the length of the key_array here
